...
CREATE TABLE IF NOT EXISTS DIRECTORS (
	...
	CONSTRAINT direсtors_pk PRIMARY KEY (DIRECTOR_ID)
);

CREATE TABLE IF NOT EXISTS FILMS_DIRECTORS (
	FILM_ID integer NOT NULL,
	DIRECTOR_ID integer NOT NULL,
	CONSTRAINT films_direсtors_fk_film FOREIGN KEY (FILM_ID) REFERENCES FILMS(FILM_ID) ON DELETE RESTRICT ON UPDATE CASCADE,
	CONSTRAINT films_direсtors_fk_genres FOREIGN KEY (DIRECTOR_ID) REFERENCES DIRECTORS(DIRECTOR_ID) ON DELETE RESTRICT ON UPDATE
	CASCADE
);
...
(
    ...
    FILM_ID BIGINT NOT NULL,
    USER_ID BIGINT NOT NULL,
    CONSTRAINT FK_REVIEWS_FILM_ID FOREIGN KEY (FILM_ID) REFERENCES FILMS ON DELETE CASCADE,
    CONSTRAINT FK_REVIEWS_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT PK_REVIEW_RATE PRIMARY KEY (REVIEW_ID, USER_ID),
    CONSTRAINT FK_REVIEW_RATE_REVIEW_ID FOREIGN KEY (REVIEW_ID) REFERENCES REVIEWS ON DELETE CASCADE,
    CONSTRAINT FK_REVIEW_RATE_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS ON DELETE CASCADE
);